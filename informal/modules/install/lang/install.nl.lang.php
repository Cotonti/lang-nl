...
$L['install_body_message1'] = 'Dit script configureert de basis installatie en configuratie van Cotonti.';
$L['install_body_message2'] = 'Wij raden aan om datas/config-sample.php te wijzigen naar datas/config.php. Zet vervolgens de CHMOD op 666 op het bestand datas/config.php voordat je dit script draait.';
$L['install_body_message3'] = 'Je dient eerst een <strong>nieuwe database</strong> aan te maken op de server.';
$L['install_chmod_value'] = 'CHMOD {$chmod}';
$L['install_complete'] = 'Installatie is succesvol afgerond!';
$L['install_complete_note'] = 'Je mag install.php verwijderen en het bestand datas/config.php terugzetten naar CHMOD 644 tot aan de volgende update voor betere beveiliging.';
...
$L['install_db_port'] = 'Database poort';
$L['install_db_port_hint'] = 'Indien deze niet standaard is';
...
$L['install_error_sql'] = 'Kan geen connectie maken met de MySQL database. Controleer de instellingen.';
$L['install_error_sql_db'] = 'Kan de juiste MySQL database niet selecteren. Controleer de instellingen.';
...
$L['install_error_sql_ver'] = 'Cotonti vereist MySQL versie 5.0.7 of nieuwer. MySQL versie is: {$ver}.';
$L['install_error_mainurl'] = 'Je dient de basis URL aan te geven voor uw website.';
...
$L['install_error_php_ver'] = 'Cotonti vereist PHP versie 5.2.3 of nieuwer. Versie is: {$ver}.';
...
$L['install_parsing_hint'] = 'Parsing modus wordt globaal ingestelt op de website. Wanneer je HTML kiest worden alle bestaande items automatisch omgezet naar HTML. Dit kan niet meer veranderd worden.';
...
$L['install_upgrade_success_note'] = 'Alle Genoa plugins zijn gedeïnstalleerd om compatibiliteits problemen te voorkomen. Deze plugins kan je zelf later bijwerken.';
