...
/**
 * Dutch formal Language File for the Admin Module (admin.nl-formal.lang.php)
 *
 * @package Cotonti
 * @version 0.9.0
...
$L['home_newpms'] = 'Nieuwe priv&eacute;berichten';
...
$L['home_ql_b2_1'] = 'Structuur van pagina\'s (categorie&euml;n)';
$L['home_ql_b2_2'] = 'Extra velden voor pagina\'s';
$L['home_ql_b2_3'] = 'Extra velden voor categorie&euml;n';
...
$L['core_pm'] = &$L['Priv&eacute;_berichten'];
$L['core_polls'] = &$L['Polls'];
$L['core_rss'] = &$L['RSS_Feeds'];
$L['core_structure'] = &$L['Categorie&euml;n'];
