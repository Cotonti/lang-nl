<?php
/**
 * Dutch formal language file for the Shield
 *
 * @package shield
 * @author Cotonti Team
 */
...
$L['info_desc'] = 'Anti-hammering beveiliging';
...
$L['shield_protect'] = 'Schild protectie geactiveerd, probeer het nogmaals in {$sec} seconden...<br />Na deze pauze kunt u de huidige pagina vernieuwen om door te gaan.<br />Laatste actie was: {$action}';
