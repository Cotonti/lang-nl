<?php
/**
 * Dutch Formal Language File for SiteXML plugin
 *
 * @package sitemap
 * @author Cotonti Team
...
$L['cfg_perpage']            = 'Max items per sitemap pagina';
$L['cfg_perpage_hint']       = 'Sitemaps worden in delen gesplitst wanneer er meerdere links zijn, zie http://yoursite/index.php?r=sitemap&a=index';
